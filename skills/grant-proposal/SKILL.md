...
- **REVIEWER_MODEL = `qwen3.8-max`** — Model used via Codex MCP for proposal review. Default reviewer model; can be changed to any model supported by your Codex setup.
...
| `reviewer model` | qwen3.8-max | Codex review model | → Codex MCP |
