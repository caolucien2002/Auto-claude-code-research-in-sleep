...
description: "Autonomously improve a generated paper via qwen3.8-max medium review \u2192 implement fixes \u2192 recompile, for 2 rounds. Use when user says \\\"\u6539\u8bba\u6587\\\", \\\"improve paper\\\", \\\"\u8bba\u6587\u6da6\u8272\u5faa\u73af\\\", \\\"auto improve\\\", or wants to iteratively polish a generated paper."
---
...
- **REVIEWER_MODEL = `qwen3.8-max`** — Model used via a secondary Codex agent for paper review.
...
Send the full paper text to qwen3.8-max medium:
...
<details>
<summary>qwen3.8-max medium Review (Round 1)</summary>
...
<details>
<summary>qwen3.8-max medium Review (Round 2)</summary>
...
- **Save FULL raw review text** — do not summarize or truncate qwen3.8-max responses
