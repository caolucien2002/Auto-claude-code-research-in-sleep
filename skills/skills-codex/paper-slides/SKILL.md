...
- **REVIEWER_MODEL = `qwen3.7-plus`** — Model used via Codex MCP for slide review.
...
Send the slide outline + selected LaTeX frames to qwen3.7-plus medium:
...
- Files:
  ...
  ├── SLIDES_REVIEW.md      # qwen3.7-plus review feedback
