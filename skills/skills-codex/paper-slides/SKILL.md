...
- **REVIEWER_MODEL = `qwen3.8-max`** — Model used via Codex MCP for slide review.
...
Send the slide outline + selected LaTeX frames to qwen3.8-max medium:
...
- Files:
  ...
  ├── SLIDES_REVIEW.md      # qwen3.8-max review feedback
