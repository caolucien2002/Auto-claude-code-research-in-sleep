...
- **REVIEWER_MODEL = `qwen3.8-max`** — Reviewer model used via a secondary Codex agent.
...
Send the revised proposal back to qwen3.8-max in the **same agent**:
...
- **ALWAYS use `reasoning_effort: medium`** for all Codex review calls.
