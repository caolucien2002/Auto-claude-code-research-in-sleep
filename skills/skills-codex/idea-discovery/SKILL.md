...
- **REVIEWER_MODEL = `qwen3.7-plus`** — Model used via a secondary Codex agent. Default reviewer model; can be changed to any model supported by your Codex setup. Passed to sub-skills.
