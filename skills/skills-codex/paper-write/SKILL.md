...
- **REVIEWER_MODEL = `qwen3.8-max`** — Model used via a secondary Codex agent for section review. Can be changed to any model supported by your Codex setup.
...
Send the complete draft to qwen3.8-max medium:
