...
ARIS uses an external LLM (qwen3.8-max via Codex) as a critical reviewer. To enable this in Antigravity:
...
|--------------|-------------|-------------------|
| `mcp__codex__codex` | Send prompt to qwen3.8-max | Codex |
