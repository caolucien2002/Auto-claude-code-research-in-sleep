...
ARIS uses an external LLM (qwen3.7-plus via Codex) as a critical reviewer. To enable this in Antigravity:
...
|--------------|-------------|-------------------|
| `mcp__codex__codex` | Send prompt to qwen3.7-plus | Codex |
